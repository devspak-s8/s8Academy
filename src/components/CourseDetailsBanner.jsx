...
import coursesData from '../data/coursesData'; // Make sure this path matches your setup
...
function CourseBanner() {
  ...
  return (
    <div className="min-h-screen bg-indigo-950 text-white">
      {/* Navigation */}
      {/* ... keep your navigation code here (optional: make it dynamic later) */}
      ...
      <main className="px-6 py-4 max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="flex flex-wrap gap-2 mb-6">
              {course.techStack.map((skill, idx) => (
                <Badge
                  key={idx}
                  variant="outline"
                  className="rounded-full bg-indigo-900/50 text-white border-indigo-700 hover:bg-indigo-800"
                >
                  {skill}
                </Badge>
              ))}
          ...
          {/* Right Column - Course Illustration */}

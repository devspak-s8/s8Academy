...
import bgImg from "../assets/img/banner-bg.png";
const navigation = [
  { name: "Product", href: "#" },
  { name: "Features", href: "#" },
...
export default function Example() {
  ...
  return (
    <div
      ...
      className="w-full max-h-screen pb-20 sm:py-20 lg:py-4"
    >
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <section className="w-full sm:py-24 grid grid-cols-12">
          <div className="container mx-auto px-4 col-span-12 lg:col-span-12">
                ...
                <div className="w-full flex justify-end py-6">
                  <div className="text-start max-w-xl">
                    ...
                    <p className="text-white text-base sm:text-lg mb-10">
                      ...
                      one greater leap forward than the building.
                    </p>
                  </div>
                </div>
